...
def parsing_arguments():
    p = argparse.ArgumentParser(description="Get the unclean Election per second of the cluster")
    p.add_argument("string_hosts", metavar="<host1:port,host2:port...> | <filename>",
